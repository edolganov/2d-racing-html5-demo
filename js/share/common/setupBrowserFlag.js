...
if(window.BrowserUtil){
    ...
    function initHtmlClasses(){
        ...
        if(BrowserUtil.isIE9()) 
            html.addClass("ie9");
        
        if(BrowserUtil.isIE10()) 
            html.addClass("ie10");
        ...
        if(BrowserUtil.isMac()) {
            ...
            else if(BrowserUtil.isIPhone()) 
                html.addClass("iphone mobile");
            else 
                html.addClass("mac-pc");
        }
        ...
        if(version){
            ...
            if(splitsByDots.length > 0) 
                shortVersion = splitsByDots[0];
